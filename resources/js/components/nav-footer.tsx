        ...
        <SidebarGroup {...props} className={`group-data-[collapsible=icon]:p-0 ${className || ''}`}>
            <SidebarGroupContent>
                <motion.div
                    ...
                    className="relative bg-gradient-to-r from-slate-800 via-[color:var(--primary-600)] to-slate-800 text-white shadow-xl border-none overflow-hidden"
                >
                    ...
                    {/* Sélecteur de thème */}
                    <motion.div 
                        className="mb-3 p-2 relative z-10"
                    ...
                    >
                        <div className="flex items-center justify-between">
                            <motion.button
                                ...
                                className={`flex items-center gap-2 px-3 py-2 rounded-full transition-all duration-300 bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/20 hover:border-white/40 group`}
                                ...
                                asChild
                                    ...
                                    >
                                        <a 
                                            ...
                                            className="flex items-center gap-3 rounded-full px-3 py-2 transition-all duration-300 hover:bg-white/10 relative overflow-hidden"
                                        >
                                            ...
                                            >
                                                {item.icon && (
                                                    <Icon 
                                                        iconNode={item.icon} 
                                                        className="h-5 w-5 transition-transform duration-300 group-hover:scale-110 text-white opacity-90 group-hover:opacity-100"
                                                    />
                                                )}
                                                ...
                                                {index === 0 && (
                                                    <motion.div
                                                        className="absolute -top-1 -right-1 w-2 h-2 pointer-events-none opacity-0 group-hover:opacity-100"
                                                        animate={{ 
                                                            rotate: [0, 360],
                                                            opacity: [0, 0.7, 0]
                                                        }}
