...
export default function CreateNeighborhood({ cities }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post(route('admin.locations.neighborhoods.store'), formData, {
            onError: (errors) => {
                setErrors(errors);
            },
        });
            ...
            <div className="container py-8">
                <div className="mb-6 flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <h1 className="text-3xl font-bold">Créer un quartier</h1>
                    </div>
                </div>
