...
export default function CreateChild({ levels }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post(route('parent.children.store'), formDataToSend, {
            onSuccess: () => {
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            <SelectItem value={true.toString()}>Actif</SelectItem>
                                            <SelectItem value={false.toString()}>Inactif</SelectItem>
                                        </SelectContent>
                                    </Select>
