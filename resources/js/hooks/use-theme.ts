...
const COLOR_PALETTES: Record<ThemeColor, Record<string, string>> = {
    ...
    cyan: {
        '50': 'oklch(0.98 0.03 200)',
        '100': 'oklch(0.95 0.06 200)',
        '200': 'oklch(0.9 0.10 200)',
        '300': 'oklch(0.8 0.14 200)',
        '400': 'oklch(0.65 0.18 200)',
        '500': 'oklch(0.5 0.22 200)',
        '600': 'oklch(0.4 0.22 200)',
        '700': 'oklch(0.3 0.20 200)',
        '800': 'oklch(0.22 0.17 200)',
        '900': 'oklch(0.16 0.14 200)',
        '950': 'oklch(0.1 0.10 200)',
    },
    red: {
    ...
    timmi_dark_blue: {
        '50':  'oklch(0.95 0.04 220)',
        '100': 'oklch(0.90 0.08 220)',
        '200': 'oklch(0.80 0.12 220)',
        '300': 'oklch(0.70 0.16 220)',
        '400': 'oklch(0.60 0.18 220)',
        '500': 'oklch(0.50 0.20 220)',
        '600': 'oklch(0.40 0.18 220)',
        '700': 'oklch(0.30 0.16 220)',
        '800': 'oklch(0.20 0.14 220)',
        '900': 'oklch(0.12 0.12 220)',
        '950': 'oklch(0.06 0.10 220)',
    },
